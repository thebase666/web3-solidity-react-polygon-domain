...
contract Domains is ERC721URIStorage {
    ...
    mapping(string => address) public domains; //传入域名 查用户add
    mapping(string => string) public records; //传入域名 查record
    mapping(uint256 => string) public names; //传入_tokenIds 查域名

    address payable public owner;

    // 定义owner带payable constructor函数带payable 赋值变量时再带payable
    // address payable public owner;
    ...
    function getAllNames() public view returns (string[] memory) {
        ...
        //生成长度为_tokenIds的空array 内容是string但为空
